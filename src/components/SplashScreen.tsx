    ...
    >
      ...
      >
        <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center shadow-2xl">
          <Trophy className="w-16 h-16 text-cdc-blue" />
        </div>
        <motion.div
          animate={{ 
            scale: [1, 1.2, 1],
      ...
      >
        <h1 className="text-4xl font-black tracking-tighter mb-2">CDC</h1>
        <p className="text-cdc-red font-bold uppercase tracking-widest text-sm">Match Prediction Game</p>
      </motion.div>
